                ...
                <form method="POST" action="{{ route('location.store') }}" class="needs-validation" novalidate>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Latitude"  value="{{ old('latitude') }}"  name="latitude">
                            @error('latitude')
                                <div class="text-danger mt-1 ">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Longitude"  value="{{ old('longitude') }}"  name="longitude">
                            @error('longitude')
                                <div class="text-danger mt-1 ">{{ $message }}</div>
                            @enderror
                        </div>
